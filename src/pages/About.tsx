...
const About = () => {
  ...
  const milestones = [{
    year: "2020",
    event: "Founded Film For Us with 5 founding members",
    icon: Target
  }, {
    year: "2021",
    event: "First community workshop with 25 participants",
    icon: Users
  }, {
    year: "2022",
    event: "Launched mobile cinema program",
    icon: Zap
  }, {
    year: "2023",
    event: "Won first documentary award at regional festival",
    icon: Award
  }, {
    year: "2024",
    event: "Expanded to 15 communities across the region",
    icon: Globe
  }];
  const team = [{
    name: "Sarah Ahmed",
    role: "Founder & Creative Director",
    experience: "15 years in documentary filmmaking"
  }, {
    name: "Michael Chen",
    role: "Education Program Manager",
    experience: "Former film school instructor"
  }, {
    name: "Priya Patel",
    role: "Community Outreach Coordinator",
    experience: "Social work and community engagement"
  }, {
    name: "David Rodriguez",
    role: "Technical Director",
    experience: "Post-production and equipment specialist"
  }];
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <Card className="border-4 border-primary shadow-bold transform rotate-1 overflow-hidden">
              <CardContent className="p-8 md:p-12">
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground">
                  <p className="mb-6">Film for Us is a non-profit cultural and educational organization committed to democratizing the art of filmmaking. We believe that everyone has a story to tell—and with the right guidance and access to tools, anyone can become a filmmaker. In an age where most people carry a camera in their pocket, we aim to turn everyday citizens into powerful visual storytellers.</p>
                  <p className="mb-6">We work at the intersection of film, education, and social empowerment, focusing particularly on underprivileged, underserved, and marginalized communities. From organizing free workshops and screenings to supporting grassroots productions and film festivals, our goal is to make filmmaking accessible to all.</p>
          ...
          <div className="mb-20">
            ...
            <div className="space-y-6">
              {milestones.map((milestone, idx) => <div key={milestone.year} className="flex items-center gap-6">
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {values.map((value, idx) => <Card key={value.title} className={`border-2 border-primary hover:shadow-bold transition-all transform ${idx % 2 === 0 ? 'hover:rotate-1' : 'hover:-rotate-1'}`}>
                  <CardContent className="p-6 text-center">
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {team.map((member, idx) => <Card key={member.name} className="border-2 border-primary shadow-sketch">
                  <CardContent className="p-6 text-center">
